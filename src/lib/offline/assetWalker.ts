...
export const ASSET_WALKER_VERSION = 5;
...
const MEDIA_FIELDS = new Set([
  "src", "poster",
  "image", "imageUrl", "image_url", "imageSrc", "image_src", "img",
  "video", "videoUrl", "video_url",
  "audio", "audioUrl", "audio_url",
  "cover", "coverUrl", "cover_url",
  "thumbnail", "thumb", "thumbUrl", "thumbnailUrl",
  "background", "backgroundImage", "backgroundUrl", "background_url", "bg", "bgImage", "bgUrl",
  "hotspotImage", "hotspot_image", "hotspotSrc", "hotspot_src", "mapImage", "mapUrl", "map_url",
